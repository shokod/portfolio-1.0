...
function ContactMe({ }: Props) {
    ...
    const onSubmit: SubmitHandler<Inputs> = formData => {
        window.location.href = `mailto:delvins@pdtco.co.za?subject=${formData.subject}&body=Hie, my name is ${formData.name}. ${formData.message} (${formData.email})';
        `;
    };
            ...
            <div className='flex flex-col space-y-3'>
                ...
                <div className='space-y-3'>
                    ...
                    <div className='flex items-center space-x-5 justify-center'>
                        ...
                        <p className='text-2xl'>5 Dev Road Drive </p>
                    </div>

                    <div className='flex items-center space-x-5 justify-center'>
                        <EnvelopeIcon className='text-[#F7AB0A] h-7 w-7 animate-bounce' />
                        <p className='text-2xl'>delvins@gmail.com</p>
                    </div>
                </div>
